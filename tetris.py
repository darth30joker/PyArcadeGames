...
def join_matrix(matrix_1, matrix_2, matrix_2_offset):
        ...
        for row in range(len(grid)):
            for column in range(len(grid[0])):
                ...
                if grid[row][column]:
                    ...
                    x = (CELL_MARGIN + WIDTH) * (column + offset_x) + BORDER_MARGIN + WIDTH // 2
                    y = SCREEN_HEIGHT - (CELL_MARGIN + HEIGHT) * (row + offset_y) + BORDER_MARGIN + HEIGHT // 2
